...
# 1. Load Data
# =========================
df = pd.read_csv(r"C:\Users\syedb\Desktop\Equinox Quantitative Analytics and Predictive Platform\data\features\AAPL_1m_features.csv")
...
y_pred_filtered = (y_prob_filtered > 0.3).astype(int)
...
joblib.dump(model, r'models/Apple_model/1m_model.pkl')
