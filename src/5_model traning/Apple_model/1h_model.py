...
# 1. Load Data
# =========================
df = pd.read_csv(r"C:\Users\syedb\Desktop\Equinox Quantitative Analytics and Predictive Platform\data\features\AAPL_1h_features.csv")
...
joblib.dump(model, r'models/Apple_model/1h_model.pkl')
