...
import os
# Load the dataset
df= pd.read_csv(r"C:\Users\syedb\Desktop\Equinox Quantitative Analytics and Predictive Platform\data\features\XAUUSD_1h_features.csv")
...
model = XGBClassifier(scale_pos_weight=scale_pos_weights, n_estimators=300, max_depth=6, learning_rate=0.05, eval_metric='aucpr')
...
joblib.dump(model, r'models/XAU_USDmodel/1h_model.pkl')
