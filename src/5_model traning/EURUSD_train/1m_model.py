...
DATA_PATH = os.path.join(BASE_DIR, "data", "features", "EURUSD_1m_features.csv")
MODEL_SAVE_PATH = os.path.join(BASE_DIR, r"models\EUR_USD model", "xgb_1m_model.joblib")
...
def main():
    try:
        ...
        logger.exception(f"An error occurred during the training pipeline: {e}")
